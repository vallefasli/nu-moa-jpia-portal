    ...
    <>
      <div className="p-4 md:p-8 max-w-7xl mx-auto pb-32 md:pb-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-[#35408e]">Verification Queue</h1>
            <p className="text-sm md:text-base text-gray-500 mt-1">Manage pending membership applications.</p>
          </div>
          <div>
